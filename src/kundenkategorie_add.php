    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-sm-6">
                ...
                <form class="mt-4" action="kundenkategorie_add_thanks.php" method="POST">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Ihre Kundenkategorie">
                    </div>
